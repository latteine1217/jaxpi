...
#SBATCH --output=logs/kf_adam_2gpu_%j.out
#SBATCH --error=logs/kf_adam_2gpu_%j.err
...
WORKDIR="${EXAMPLE_DIR}/results_adam_2gpu_${SLURM_JOB_ID}"

mkdir -p ${PROJECT_DIR}/logs

echo "==========================="
echo "Kolmogorov Flow - Adam 雙 GPU 訓練"
echo "==========================="
...
echo "訓練配置 (Adam)"
echo "========================================="
echo "架構: PirateNet (4 layers, 384 hidden dim)"
echo "優化器: Adam"
...
echo "==========================="
echo "工作目錄: ${WORKDIR}"
echo "Checkpoints: ~/jaxpi/pirate_Re10000/ckpt/"
echo "日誌檔案:"
echo "  - stdout: ~/jaxpi/logs/kf_pirate_2gpu_${SLURM_JOB_ID}.out"
echo "  - stderr: ~/jaxpi/logs/kf_pirate_2gpu_${SLURM_JOB_ID}.err"
...
du -sh ~/jaxpi/pirate_Re10000/ckpt/ 2>/dev/null || echo "Checkpoint 目錄不存在"
