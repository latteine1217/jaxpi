"""Stage A: Dense LES data constraint (full dataset)."""
...
def get_config():
    """Stage A: LES prefit (no sensor data)."""
    ...
    wandb.name = "pirate_les_stage1"
    wandb.group = "les_then_sensor"
    wandb.tags = ["les", "stage1", "no_sensor", "Re100000"]
    wandb.notes = "Stage A: LES prefit, data loss disabled"
    wandb.sweep_id = None
