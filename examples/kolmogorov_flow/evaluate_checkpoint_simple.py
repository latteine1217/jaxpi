...
def evaluate_final_step(config_name, checkpoint_path):
    """
    評估所有窗口的最終時間步誤差
    """
...
def main():
    parser = argparse.ArgumentParser(description="評估所有窗口的最終誤差")
    parser.add_argument(
    ...
    # 評估
    results = evaluate_final_step(args.config, args.checkpoint_path)
