...
def get_config():
    """SOAP + 100 QR-pivot sensors config for Kolmogorov Re=1e6.

    Extends paper_repro_soap with sensor data constraints to break the
    degenerate time-stationary solution problem. Sensor positions were
    selected via QR column pivoting on the DNS snapshot matrix (u, v, p,
    omega, |∇u|, |∇v| at every 0.1s), giving 100 maximally informative
    spatial locations that explain 91.4% of total field variance.
    """
    ...
    wandb.name = "re1e6_n2048_ke024_soap_sensor100"
