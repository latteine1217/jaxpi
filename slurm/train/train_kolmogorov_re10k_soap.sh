#!/bin/bash
#SBATCH --job-name=train_kf_re10k_soap
#SBATCH --output=logs/train_kf_re10k_soap_%j.out
#SBATCH --error=logs/train_kf_re10k_soap_%j.err
...
CONFIG_PATH="${CONFIG_PATH:-examples/kolmogorov_flow/configs/re10k_soap.py}"
RUN_SLUG="${RUN_SLUG:-train_kf_re10k_soap}"
