#!/bin/bash
#SBATCH --job-name=train_kf_stage1_adam
#SBATCH --output=logs/train_kf_stage1_adam_%j.out
#SBATCH --error=logs/train_kf_stage1_adam_%j.err
...
RUN_SLUG="${RUN_SLUG:-train_kf_stage1_adam}"
