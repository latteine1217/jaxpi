#!/bin/bash
#SBATCH --job-name=train_kf_stage1_soap
#SBATCH --output=logs/train_kf_stage1_soap_%j.out
#SBATCH --error=logs/train_kf_stage1_soap_%j.err
...
RUN_SLUG="${RUN_SLUG:-train_kf_stage1_soap}"
